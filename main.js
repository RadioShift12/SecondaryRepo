...
/*
    Imports are something I knew about, but never figured out how to use.
    I mostly have just spammed <script> tags in my HTML to get access to different files.
    It is cool to see how to correctly use it, and it makes the code much cleaner and easier to manage. 
*/
